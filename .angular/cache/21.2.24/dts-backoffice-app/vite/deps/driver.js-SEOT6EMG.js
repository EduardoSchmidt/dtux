...
function Ae(e = {}) {
  ...
  function v(a = 0) {
    ...
    j(__spreadProps(__spreadValues({}, c), {
  ...
  const y = {
    ...
    setConfig: F,
    setSteps: (a) => {
      X(), F(__spreadProps(__spreadValues({}, s()), {
        steps: a
      }));
    },
    getConfig: s,
    ...
    highlight: (a) => {
      r(), j(__spreadProps(__spreadValues({}, a), {
        popover: a.popover ? __spreadValues({
          showButtons: [],
          showProgress: false,
          progressText: ""
        }, a.popover) : void 0
...
//# sourceMappingURL=driver.js-SEOT6EMG.js.map
