...
function main(options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (configureNewIcon.toLowerCase() === 'yes' ||
            ...
            return (0, schematics_1.chain)([(0, package_config_1.updatePackageJson)('21.31.0', changes_1.updateDepedenciesVersion), createUpgradeRule(), postUpdate()]);
        }
        else {
            return (0, schematics_1.chain)([
                (0, package_config_1.updatePackageJson)('21.31.0', changes_1.updateDepedenciesVersion),
