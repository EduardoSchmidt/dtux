 ...
 * </example>
 */
export declare class PoBadgeComponent extends PoBadgeBaseComponent implements OnInit, OnChanges {
    ...
    initialize(): void;
    getChangeStyle(): string;
    setLiterals(): void;
    setStatus(): void;
    switchIconStatus(): void;
    private setBadgeNotification;
    private setBadgeValue;
    private checkBadgeValue;
