...
export declare class PoDynamicViewBaseComponent extends PoDynamicSharedBase {
    ...
    protected getValueFields(): {
        ...
        optionsService?: string | import("../..").PoComboFilter | import("../..").PoMultiselectFilter;
        optionsMulti?: boolean;
        searchService?: string | import("..").PoDynamicViewRequest;
        booleanTrue?: string;
        booleanFalse?: string;
        params?: any;
        key?: boolean;
        ...
        visible?: boolean;
        divider?: string;
        type?: string | import("..").PoDynamicFieldType;
        container?: string;
        value: any;
        cssClass: string;
    }[];
