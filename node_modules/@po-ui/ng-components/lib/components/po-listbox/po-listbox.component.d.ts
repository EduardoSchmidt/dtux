...
export declare class PoListBoxComponent extends PoListBoxBaseComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    onSelectCheckBoxItem(option: any): void;
    isSelectedItem(option: any): boolean;
    changeAllEmit(event: KeyboardEvent): void;
    onSelectTabs(tab: any): void;
    onActivatedTabs(tab: any): void;
