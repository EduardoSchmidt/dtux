 ...
 */
export declare abstract class PoSearchAiBaseComponent extends PoInputGeneric implements OnDestroy {
    protected aiErrorMessage: string;
    protected aiLoading: boolean;
     ...
     * @default `[]`
     */
    columns: import("@angular/core").InputSignal<PoSearchAiColumn[]>;
    protected readonly effectiveLiterals: import("@angular/core").Signal<any>;
    /**
     * @optional
     *
     * @description
     ...
     */
    error: import("@angular/core").OutputEmitterRef<PoSearchAiError>;
     ...
     */
    literals: import("@angular/core").InputSignal<PoSearchAiLiterals>;
    /**
     * @optional
     *
     * @description
     ...
     */
    lowConfidence: import("@angular/core").OutputEmitterRef<PoSearchAiResult>;
    /**
     * @optional
     *
     * @description
     ...
     * @default `0.5`
     */
    minConfidence: import("@angular/core").InputSignalWithTransform<number, number>;
    /**
     * @optional
     *
     * @description
     ...
     */
    result: import("@angular/core").OutputEmitterRef<PoSearchAiResult>;
     ...
     * @default `10000`
     */
    timeout: import("@angular/core").InputSignalWithTransform<number, number>;
    /**
     * @optional
     *
     * @description
    ...
    extraValidation(_c: AbstractControl): {
        [key: string]: any;
    };
    hasValue(): boolean;
    ngOnDestroy(): void;
